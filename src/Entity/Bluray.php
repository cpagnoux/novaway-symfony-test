...
/**
 * @ORM\Entity(repositoryClass="App\Repository\BlurayRepository")
 */
class Bluray
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Director", inversedBy="blurays")
     * @ORM\JoinColumn(nullable=false)
     */
    private $director;

    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Actor", inversedBy="blurays")
     */
    private $actors;
